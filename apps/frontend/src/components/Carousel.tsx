...
const Slider = ({
  ...
  const percentageValue = useMemo(
    () => percentage(activeItem, positions.length - constraint),
    [activeItem, positions, constraint], // Dependencies that trigger recalculation
  );
    ...
    <>
      ...
      <Flex w={`${itemWidth}px`} mt={`${gap / 2}px`} mx="auto">
        <Button
          ...
          variant="link"
          minW={0}
          isDisabled={percentageValue === 0}
          _hover={{
            opacity: percentageValue !== 0 && 0.6,
          }}
        >
        ...
        <Button
          ...
          zIndex={2}
          minW={0}
          isDisabled={percentageValue === 100}
          _hover={{
            opacity: !percentageValue === 100 && 0.6,
          }}
        >
