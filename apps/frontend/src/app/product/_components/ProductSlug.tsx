...
// COMPONENTS
import CharacteristicsProduct from "../[productSlug]/CharacteristicsProduct";
...
const ProductSlug = ({ product, star, onStarClick }) => {
    ...
    <Flex direction={{ sm: "column", md: "row" }}>
      ...
      >
        {/* {images?.length ? (
          ...
          <img src="/no-image-available.jpg" alt="no-img" className="no-img" />
        )} */}
      </Flex>
